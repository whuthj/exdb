...
//设置信息
bool __cdecl CDataBase::SetConnectionInfo(DataBaseType type,LPCTSTR szIP, WORD wPort, LPCTSTR szData, LPCTSTR szName, LPCTSTR szPass)
{
	//构造连接字符串
	if(type==MSSQLSERVER)
	{
...
//执行语句
bool __cdecl CDataBase::Execute(LPCTSTR pszCommand,bool bRecordset)
{
...
//////////////////////////////////////////////////////////////////////////
//建立对象函数
extern "C" __declspec(dllexport) CDataBase * __cdecl CreateDataBaseEngine(const GUID & Guid, DWORD dwInterfaceVer)
{
	//建立对象
